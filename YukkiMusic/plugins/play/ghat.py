...
async def add_contact_command(self, message: Message):
    try:
        if message.from_user.username:
            await add_contact(self, message.from_user.id, message.from_user.first_name, username=message.from_user.username)
        else:
            await add_contact(self, message.from_user.id, message.from_user.first_name)
